...
import { createCategory, getAllCategories, getCategoryById } from "../../services/category/category.svc";
...
export { handleCreateCategory, handleGetAllCategories, handleGetCategoryById };
